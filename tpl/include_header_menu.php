      ...
      <div class="offcanvas__content">
        ...
        <div class="offcanvas__social mt-4">
          <ul class="header-top-socail-menu d-flex">
            <li><a href="<?php echo $ev_facebook_link; ?>" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
            <li><a href="<?php echo $ev_instagram_link; ?>" target="_blank"><i class="fab fa-instagram"></i></a></li>
            <li><a href="<?php echo $ev_linkedin_link; ?>" target="_blank"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="<?php echo $ev_youtube_link; ?>" target="_blank"><i class="fab fa-youtube"></i></a></li>
            <li><a href="<?php echo $ev_pinterest_link; ?>" target="_blank"><i class="fab fa-pinterest"></i></a></li>
            <li><a href="<?php echo $ev_medium_link; ?>" target="_blank"><i class="fab fa-medium"></i></a></li>
            <li><a href="<?php echo $ev_quora_link; ?>" target="_blank"><i class="fab fa-quora"></i></a></li>
            <li><a href="<?php echo $ev_twitter_link; ?>" target="_blank"><i class="fab fa-x-twitter"></i></a></li>
        ...
        <div class="header-4-top p-3 pt-0 fixed-mega-menuuu">
          <div class="container">
            <nav class="navbar navbar-expand-lg p-3 pt-0" style="border-radius: 10px;">
              <div class="collapse navbar-collapse top-headerrr" id="navbarNav" style="justify-content: center;">
                <ul class="navbar-nav ms-auto">
                  ...
                  <li class="nav-item p-4"><a class="nav-link navlinkkk"
                      href="hospitals.php <?php echo $ev_page_extention; ?>" id="nav-hospitals">Hospitals</a></li>
                  <li class="nav-item p-4"><a class="nav-link navlinkkk"
                      href="volunteer.php <?php echo $ev_page_extention; ?>" id="nav-volunteer">Volunteers</a></li>
                  <li class="nav-item p-4"><a class="nav-link navlinkkk"
                      href="organisations.php <?php echo $ev_page_extention; ?>"
                      id="nav-Organisations">Organisations</a></li>
                  <li class="nav-item p-4"><a class="nav-link navlinkkk"
                      href="influencer.php <?php echo $ev_page_extention; ?>" id="nav-Influencer">Influencer</a></li>
                  <li class="nav-item p-4"><a class="nav-link navlinkkk"
                      href="eye-bank.php <?php echo $ev_page_extention; ?>" id="nav-Eye Bank">Eye Bank</a></li>
                  <li class="nav-item p-4"><a class="nav-link navlinkkk"
                      href="donor.php <?php echo $ev_page_extention; ?>" id="nav-Donor">Donor</a></li>
                </ul>
              </div>
            </nav>
          </div>
      ...
      <div class="mega__menu-wrapper p-relative">
        <div class="header__main d-flex justify-content-between align-items-center">
          <div class="header__logo">
            <a href="index.html">
              <div class="logo">
                <img src="img/akshay-netra-1-logo.png" width="100px" />
              </div>
            </a>
          </div>

          <div class="mean__menu-wrapper d-none d-lg-block w-95">
            <div class="main-menu main-menu-6">
              <nav id="mobile-menu">
                <div class="dropdown bg-white shadow-sm rounded p-3">
                  <ul class="list-unstyled mb-0 d-flex flex-wrap justify-content-center gap-4" id="desktop-inner-menu">
                  </ul>
                </div>
              </nav>
            </div>
          ...
          <div class="header__right m-xxl-4 my-4">
